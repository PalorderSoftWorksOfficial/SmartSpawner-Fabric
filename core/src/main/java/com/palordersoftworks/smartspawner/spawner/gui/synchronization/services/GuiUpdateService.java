package com.palordersoftworks.smartspawner.spawner.gui.synchronization.services;
...
public class GuiUpdateService {
    ...
    private SpawnerData extractSpawnerData(Object info) {
        if (info instanceof com.palordersoftworks.smartspawner.spawner.gui.synchronization.managers.ViewerTrackingManager.ViewerInfo viewerInfo) {
