package com.palordersoftworks.smartspawner.spawner.gui.storage;

import com.palordersoftworks.smartspawner.SmartSpawner;
import com.palordersoftworks.smartspawner.api.events.SpawnerDropAllEvent;
import com.palordersoftworks.smartspawner.api.events.SpawnerTakeAllEvent;
import com.palordersoftworks.smartspawner.language.MessageService;
import com.palordersoftworks.smartspawner.spawner.gui.layout.GuiLayoutConfig;
import com.palordersoftworks.smartspawner.spawner.gui.storage.filter.FilterConfigUI;
import com.palordersoftworks.smartspawner.spawner.gui.main.SpawnerMenuUI;
...
import com.palordersoftworks.smartspawner.spawner.lootgen.loot.LootItem;
...
import com.palordersoftworks.smartspawner.language.LanguageManager;
...
import static com.palordersoftworks.smartspawner.spawner.gui.sell.SpawnerSellConfirmUI.PreviousGui.STORAGE;
...
public class SpawnerStorageAction implements Listener {
    ...
    private void handleControlSlotClick(Player player, int slot, StoragePageHolder holder,
        ...
        Optional<com.palordersoftworks.smartspawner.spawner.gui.layout.GuiButton> buttonOpt = layout.getButtonAtSlot(slot);
    ...
    private void handleDropPageItems(Player player, SpawnerData spawner, Inventory inventory) {
        ...
        if (plugin.getSpawnerActionLogger() != null) {
            plugin.getSpawnerActionLogger().log(com.palordersoftworks.smartspawner.logging.SpawnerEventType.SPAWNER_DROP_PAGE_ITEMS, builder ->
    ...
    private void handleSortItemsClick(Player player, SpawnerData spawner, Inventory inventory) {
        ...
        if (plugin.getSpawnerActionLogger() != null) {
            plugin.getSpawnerActionLogger().log(com.palordersoftworks.smartspawner.logging.SpawnerEventType.SPAWNER_ITEMS_SORT, builder ->
                    builder.player(player.getName(), player.getUniqueId())
                            .location(spawner.getSpawnerLocation())
                            .entityType(spawner.getEntityType())
    ...
    private void openLootPage(Player player, SpawnerData spawner, int page) {
        ...
        if (plugin.getSpawnerActionLogger() != null) {
            plugin.getSpawnerActionLogger().log(com.palordersoftworks.smartspawner.logging.SpawnerEventType.SPAWNER_STORAGE_OPEN, builder ->
                    builder.player(player.getName(), player.getUniqueId())
                            .location(spawner.getSpawnerLocation())
                            .entityType(spawner.getEntityType())
    ...
    public void handleTakeAllItems(Player player, Inventory sourceInventory) {
        ...
        if (result.anyItemMoved) {
            ...
            if (plugin.getSpawnerActionLogger() != null) {
                ...
                plugin.getSpawnerActionLogger().log(com.palordersoftworks.smartspawner.logging.SpawnerEventType.SPAWNER_ITEM_TAKE_ALL, builder ->
                        builder.player(player.getName(), player.getUniqueId())
                                .location(spawner.getSpawnerLocation())
                                .entityType(spawner.getEntityType())
